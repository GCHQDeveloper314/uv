    ...
    fn conflicts_as_marker() {
        ...
        assert_eq!(
            ...
            "(extra == 'extra-3-pkg-bar' and extra != 'extra-3-pkg-foo' and extra != 'extra-3-pkg-fox') \
             or (extra != 'extra-3-pkg-bar' and extra != 'extra-3-pkg-fox') \
             or (extra != 'extra-3-pkg-ant' and extra != 'extra-3-pkg-foo') \
             or (extra != 'extra-3-pkg-ant' and extra != 'extra-3-pkg-bar')",
        );
