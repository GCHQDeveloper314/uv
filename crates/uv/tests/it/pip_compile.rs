...
fn no_strip_markers_multiple_markers() -> Result<()> {
    ...
    outcome==1.3.0.post0
        # via trio
    pycparser==2.21 ; os_name == 'nt' and implementation_name != 'pypy'
        # via cffi
    sniffio==1.3.1
        # via trio
    sortedcontainers==2.4.0
...
fn universal_disjoint_locals() -> Result<()> {
    ...
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --universal
    cmake==3.28.4 ; platform_system == 'Linux' and platform_machine == 'x86_64'
        # via triton
    filelock==3.13.1
        # via
        #   torch
    ...
    jinja2==3.1.3
        # via torch
    lit==18.1.2 ; platform_system == 'Linux' and platform_machine == 'x86_64'
        # via triton
    markupsafe==2.1.5
        # via jinja2
    mpmath==1.3.0
...
fn universal_disjoint_base_or_local_requirement() -> Result<()> {
    ...
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --universal
    cmake==3.28.4 ; (platform_system != 'Linux' and python_full_version < '3.11') or (platform_machine != 'x86_64' and python_full_version < '3.11') or (platform_system == 'Linux' and platform_machine == 'x86_64' and python_full_version < '3.13')
        # via
        #   pytorch-triton-rocm
        #   triton
    .
    ...
    jinja2==3.1.3
        # via torch
    lit==18.1.2 ; (platform_system != 'Linux' and python_full_version < '3.11') or (platform_machine != 'x86_64' and python_full_version < '3.11') or (platform_system == 'Linux' and platform_machine == 'x86_64' and python_full_version < '3.13')
        # via
        #   pytorch-triton-rocm
        #   triton
    markupsafe==2.1.5
    ...
    torch==2.0.0+rocm5.4.2 ; python_full_version < '3.11'
        ...
        #   example
        #   pytorch-triton-rocm
    triton==2.0.0 ; platform_system == 'Linux' and platform_machine == 'x86_64' and python_full_version >= '3.11' and python_full_version < '3.13'
        # via torch
    typing-extensions==4.10.0
        # via torch
...
fn universal_nested_overlapping_local_requirement() -> Result<()> {
    ...
    fsspec==2024.3.1 ; platform_machine != 'x86_64'
        # via torch
    intel-openmp==2021.4.0 ; platform_system == 'Windows' and platform_machine != 'x86_64'
        # via mkl
    jinja2==3.1.3
        # via torch
    lit==18.1.2 ; platform_system == 'Linux' and platform_machine == 'x86_64'
    ...
    markupsafe==2.1.5
        # via jinja2
    mkl==2021.4.0 ; platform_system == 'Windows' and platform_machine != 'x86_64'
        # via torch
    mpmath==1.3.0
        # via sympy
    networkx==3.2.1
    ...
    sympy==1.12
        # via torch
    tbb==2021.11.0 ; platform_system == 'Windows' and platform_machine != 'x86_64'
        # via mkl
    torch==2.0.0+cu118 ; platform_machine == 'x86_64'
        # via
        #   -r requirements.in
...
fn universal_nested_disjoint_local_requirement() -> Result<()> {
    ...
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --universal
    cmake==3.28.4 ; os_name == 'Linux' and platform_system == 'Linux' and platform_machine == 'x86_64'
        # via triton
    . ; os_name == 'Linux'
        # via -r requirements.in
    filelock==3.13.1
    ...
    jinja2==3.1.3
        # via torch
    lit==18.1.2 ; os_name == 'Linux' and platform_system == 'Linux' and platform_machine == 'x86_64'
        # via triton
    markupsafe==2.1.5
        # via jinja2
    ...
    torch==2.3.0+rocm6.0 ; os_name != 'Linux'
        # via -r requirements.in
    triton==2.0.0 ; os_name == 'Linux' and platform_system == 'Linux' and platform_machine == 'x86_64'
        # via torch
    typing-extensions==4.10.0
        # via torch
...
fn universal_overlap_extra_base() -> Result<()> {
    ...
    click==8.1.7
        # via flask
    colorama==0.4.6 ; sys_platform != 'darwin' and platform_system == 'Windows'
        # via click
    flask==3.0.2
        # via -r requirements.in
    itsdangerous==2.1.2
...
fn emit_marker_expression_exciting_linux() -> Result<()> {
    ...
    #    platform_system == 'Linux' and platform_python_implementation == 'CPython' and python_full_version == '3.12.6'
    anyio==4.3.0
        # via -r requirements.in
    idna==3.6
        # via anyio
...
fn emit_marker_expression_direct() -> Result<()> {
    ...
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --python-platform linux --emit-marker-expression
    # Pinned dependencies known to be valid for:
    #    sys_platform == 'linux' and platform_system == 'Linux' and platform_python_implementation == 'CPython' and python_full_version == '3.12.6'
    anyio==4.3.0
        # via -r requirements.in
    idna==3.6
        # via anyio
...
fn emit_marker_expression_pypy() -> Result<()> {
    ...
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --python-platform linux --emit-marker-expression
    # Pinned dependencies known to be valid for:
    #    implementation_name == 'cpython' and python_full_version == '3.12.6'
    pendulum==3.0.0
        # via -r requirements.in
